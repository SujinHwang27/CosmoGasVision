...
- **Run target**: the *first* Stage 2a-Revalidation run on the local MLflow server (`http://127.0.0.1:5000`) becomes the canonical Stage 2a artifact — to be appended here once recorded.
