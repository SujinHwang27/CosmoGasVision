...
|:--- |:--- |:--- |:--- |:--- |
| **Stage 0** | Track founding + proposal of record | 🟧 **SCAFFOLDED 2026-07-24 (user go); prior-art sweep LANDED** (`design/prior_art_sweep_20260724.md`) → **PI founding ratification + data-engineer cube enumeration IN PROGRESS** (user directive 2026-07-24: hold paper, make feedback-latent launchable) | Proposal + ratified gates | Third track of record; user-primary direction ([FW-2] on exp/unet-inversion, banked 2026-07-24) |
