...
| **Stage 1** | Plumbing + smoke (SIREN auto-decoder, ρ-only forward) | ⏳ **AUTHORIZED, not started** — [F-02] §4 spec; blockers B2+B3 first; then core-implementer A2/A4/A5/A6/A7 + support-researcher A1/B3 | [F-02] §4(c) s1–s3 + anti-collapse c1/c2 | 7 rungs / 7 artifacts; $0 local, no compute |
