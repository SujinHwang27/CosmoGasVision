...
| **Stage 2** | Baseline 3D U-Net training + corrected-metric eval | 🟢 **s-ladder DISPATCHED 2026-07-23** per [U-06] spec (`design/u06_stage2_spec.md`): 4-level base-32 U-Net ≈5.5M params, MSE on x, smoke gates s1–s3 with numeric thresholds, N=200 null-band protocol, U-G controls from first smoke; **pre-Juno blockers B1 (panel pre-review) + B2 (Juno reachability + cost block)** | [U-06] §(d) smoke gates; G2 at Stage-2 close | R28 9≥9; Juno needs A1–A9 green |
