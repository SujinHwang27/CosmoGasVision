...
\end{equation}
allowing loss gradients to propagate back through the damping wings to the MLP parameters $\theta$. The integrator was audited end-to-end after a factor-12.9 damping-coefficient fix; the explicit-grid probe of \S\ref{sec:method:gridprobe} is supervised through the same forward model.
